...
/**
 * Smart Monitor - Detects historical and new responses
 * Solves the issue of monitor missing completed responses
 */
...
class SmartMonitor {
    constructor() {
        ...
        this.lastOutput = '';
        this.processedResponses = new Set(); // Track processed responses
