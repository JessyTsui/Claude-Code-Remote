...
### January 2025
- **2025-08-01**: Add full execution trace in email notifications with configurable subagent activities ([#11](https://github.com/JessyTsui/Claude-Code-Remote/issues/11) by [@vaclisinc](https://github.com/vaclisinc))
- **2025-08-01**: Add configuration to disable subagent notifications ([#10](https://github.com/JessyTsui/Claude-Code-Remote/pull/10) by [@vaclisinc](https://github.com/vaclisinc))
